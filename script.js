document.addEventListener('DOMContentLoaded', (event) => {
        ...
        if (userText.trim() !== '') {
            ...
            fetch('/send_message', {
                ...
                .then(data => {
                    ...
                    chat.scrollTop = chat.scrollHeight; // Ensure the chat window scrolls to the latest message
                })
                .catch((error) => {
                    chat.removeChild(typingIndicator);
    ...
    // Ensure the chat window scrolls to the latest message on initial load and after sending a message
    ...
    // Fix for eslint issue: Parsing error: Unexpected token
});